...
class MapunitpolysAddFields(QgsProcessingAlgorithm):

    def initAlgorithm(self, config=None):
        self.addParameter(QgsProcessingParameterFeatureSink('Mapunitpolys', 'MapUnitPolys', type=QgsProcessing.TypeVectorAnyGeometry, createByDefault=True, supportsAppend=True, defaultValue=None))
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        alg_params = {
            ...
            'OUTPUT': parameters['Mapunitpolys']
        }
        outputs['Mapunitpolys_id'] = processing.run('native:addfieldtoattributestable', alg_params, context=context, feedback=feedback, is_child_algorithm=True)
        results['Mapunitpolys'] = outputs['Mapunitpolys_id']['OUTPUT']
        return results

    def name(self):
        return 'MapUnitPolys Add Fields'
